...
export default function NotFoundPage() {
  return <main className="min-h-screen bg-[#0a0a0c] flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="font-mono text-[#c8901a] text-sm tracking-[0.3em] uppercase mb-4" data-editable="true" data-webedit-id="webedit-411">{content["webedit-411"].value}</p>
      <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#f9f6f0] mb-4" data-editable="true" data-webedit-id="webedit-412">{content["webedit-412"].value}</h1>
      <p className="text-[#f9f6f0]/40 font-light max-w-md mb-8" data-editable="true" data-webedit-id="webedit-413">{content["webedit-413"].value}</p>
