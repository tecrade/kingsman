  ...
  return <footer className="bg-[#0a0a0c] border-t border-[#c8901a]/12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2.5 mb-5 group w-fit">
              ...
              <span className="font-serif text-xl font-bold tracking-[0.18em] text-[#f9f6f0] uppercase" data-editable="true" data-webedit-id="webedit-304">{content["webedit-304"].value}</span>
            </Link>
            <p className="text-sm text-[#f9f6f0]/40 leading-relaxed max-w-xs font-light" data-editable="true" data-webedit-id="webedit-305">{content["webedit-305"].value}</p>
            {/* Social links */}
      ...
      <div className="border-t border-white/5 px-6 py-5">
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-[#f9f6f0]/20 tracking-wide" data-editable="true" data-webedit-id="webedit-316">{content["webedit-316"].value}{new Date().getFullYear()}{content["webedit-316"].value}</p>
