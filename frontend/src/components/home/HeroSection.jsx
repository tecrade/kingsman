...
const HERO_SLIDES = content["webedit-72"].value;
export default function HeroSection() {
  ...
  return <section id="hero" className="relative h-screen min-h-[640px] overflow-hidden" aria-label="Hero section">
        ...
        <div className="max-w-screen-xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <div className={`inline-flex items-center gap-3 mb-6 transition-all duration-400 ${transitioning ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
              ...
              <span className="font-mono text-[10px] text-[#c8901a] tracking-[0.35em] uppercase" data-editable="true" data-webedit-id="webedit-aliasing-67">
                {slide.accent}
              </span>
            </div>
          ...
          }} data-editable="true" data-webedit-id="webedit-aliasing-68">
              {slide.headline}
            </h1>
          ...
          }} data-editable="true" data-webedit-id="webedit-aliasing-69">
              {slide.subheadline}
            </p>
          ...
          }} data-editable="true" data-webedit-id="webedit-aliasing-70">
              {slide.body}
            </p>
            ...
            transitionDelay: '240ms'
              ...
              <Link to={slide.ctaHref} id={`hero-cta-${activeIndex}`} className="flex items-center gap-2.5 px-7 py-3.5 bg-[#c8901a] hover:bg-[#dda830] text-[#0a0a0c] font-semibold text-sm tracking-[0.12em] uppercase rounded transition-colors duration-200 group" data-editable="true" data-webedit-id="webedit-aliasing-71">
                {slide.cta}
      ...
      {/* Slide indicators */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-3 z-10" data-editable="true" data-webedit-id="webedit-72">
